...
- Complete enemy sprite coverage beyond the current A/B rotation groups and
  front-facing attack frames: mirrored back angles, pain/death frames, richer
  attack angles, and more faithful thing placement still need work.
