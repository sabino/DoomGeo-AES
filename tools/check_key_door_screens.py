...
def main() -> int:
    ...
    message_box = (360, 120, 610, 260)
    hud_box = (0, 560, 960, 672)
    initial_message = color_counts(images["initial"], message_box)
    missing_message = color_counts(images["missing"], message_box)
    picked_message = color_counts(images["picked"], message_box)
    opened_message = color_counts(images["opened"], message_box)
    ...
    require_below(errors, root / names["initial"], "pre-key message", initial_message, "green", 200)
