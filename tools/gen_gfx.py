...
FLOOR_PERSPECTIVE_BASE = CEILING_PERSPECTIVE_BASE + CEILING_PERSPECTIVE_TILES
TITLEPIC_BASE = FLOOR_PERSPECTIVE_BASE + FLOOR_PERSPECTIVE_TILES
TITLEPIC_COLS = 20
TITLEPIC_ROWS = 13
...
def recompute_layout() -> None:
    ...
    global BG_HALF_TILES, CEILING_PERSPECTIVE_ROWS, FLOOR_PERSPECTIVE_ROWS
    global CEILING_PERSPECTIVE_TILES, FLOOR_PERSPECTIVE_TILES
...
def apply_simple_map_layout(simple_map: bool) -> None:
    global BG_HALF_ROWS, BG_FLOOR_ROWS, PLANE_HORIZON, PLANE_GAME_H
